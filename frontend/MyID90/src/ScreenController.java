...
public class ScreenController extends JFrame {
	...
	public static JPanel mainPanel = new JPanel(cl);
	...
	public static HashMap<String, JPanel> panelMap = new HashMap<String, JPanel>();
	...
	// I modified this method to use the builder.
	public static synchronized ScreenController getInstance() {
		if (sc == null) {
			ScreenControllerBuilder scb = new ScreenControllerBuilder();
			sc = new ScreenController();
			scb.buildComponent(sc);
		}
		return sc;
	}
